-- Remove the dependency on the restricted agent_os_department_id helper from
-- the caller-authorized recovery function.
...
declare
  ...
  v_technology_department_id uuid;
begin
  select d.id into v_technology_department_id
  ...
  if current_user <> 'service_role'
     ...
     and public.get_my_department() is distinct from v_technology_department_id then
